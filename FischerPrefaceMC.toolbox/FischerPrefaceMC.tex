...
\setboolean{shading}{true}
 ...
 {\MODULE} FischerPrefaceMC}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{FischerPreface} modified to be model checked\ensuremath{.
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{-} Reals}: replaced with \ensuremath{Naturals
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{-} Real}: replaced with \ensuremath{Nat
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{-} Infinity}: adding a \ensuremath{{\CONSTANT}}
 \ensuremath{Infinity} (a model value)
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\EXTENDS} Naturals}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} Max ( a ,\, b ) \.{\defeq}
 {\IF} a \.{\geq} b \.{\THEN} a \.{\ELSE} b}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} {\CONSTANTS}\@s{4.1} Thread
 ,\, Delta ,\, Epsilon ,\, Infinity}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} {\ASSUME}}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} \.{\land} Delta
 \.{\in} Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} \.{\land} Epsilon
 \.{\in} Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\land} 0 \.{<}
 Delta}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land} Delta
 \.{\leq} Epsilon}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} NotAThread \.{\defeq}
 {\CHOOSE} t \.{:} t \.{\notin} Thread}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} {\VARIABLES} x ,\, pc ,\,
 ubTimer ,\, lbTimer ,\, now ,\, counter}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} vars \.{\defeq} {\langle} x
 ,\, pc ,\, ubTimer ,\, lbTimer ,\, now ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 x \.{\in} Thread \.{\cup} \{ NotAThread \}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 pc \.{\in} [ Thread \.{\rightarrow} \{\@w{ncs} ,\,\@w{a} ,\,\@w{b} ,\,\@w{c}
 ,\,\@w{cs} ,\,\@w{d} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 ubTimer \.{\in} [ Thread \.{\rightarrow} Nat \.{\cup} \{ Infinity \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 lbTimer\@s{2.81} \.{\in} [ Thread \.{\rightarrow} Nat \.{\cup} \{ Infinity
 \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}}%
\@y{\@s{7.5}%
 \ensuremath{\.{\land} now \.{\in} Nat \.{\,\backslash\,}\.{*} now} is
 unbounded
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} counter
 \.{\in} [ Thread \.{\rightarrow} Nat ]}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} x \.{=}
 NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land} pc \.{=}
 [ t\@s{8.11} \.{\in} Thread \.{\mapsto}\@w{ncs} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land} ubTimer
 \.{=} [ t \.{\in} Thread \.{\mapsto} Infinity ]}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\land}
 lbTimer\@s{2.81} \.{=} [ t \.{\in} Thread \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land} now \.{=}
 0}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land} counter
 \.{=} [ t \.{\in} Thread \.{\mapsto} 0 ]}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} At ( t ,\, loc ) \.{\defeq}
 pc [ t ]\@s{6.50} \.{=} loc}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} GoTo ( t ,\, loc )
 \.{\defeq} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ t ] \.{=} loc ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} GoFromTo ( t ,\, loc1 ,\,
 loc2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land} At ( t
 ,\, loc1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\land} GoTo ( t
 ,\, loc2 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} TimedOut ( t ,\, timer )
 \.{\defeq} timer [ t ] \.{=} 0}%
\@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} MutualExclusion \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{8.2} \A\, t1 ,\, t2
 \.{\in} Thread \.{:} ( t1 \.{\neq} t2 ) \.{\implies} {\lnot} At ( t1
 ,\,\@w{cs} ) \.{\lor} {\lnot} At ( t2 ,\,\@w{cs} )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 15:59:41 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created Sat \ensuremath{Aug} 07 15:53:10
