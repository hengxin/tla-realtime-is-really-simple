...
\setboolean{shading}{true}
 ...
 {\MODULE} Fischer1}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} FischerPreface}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} SetTimer ( t ,\, timer ,\,
 tau ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}\@s{16.4} timer \.{'} \.{=} [
 timer {\EXCEPT} {\bang} [ t ] \.{=} tau ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} ResetUBTimer ( t ,\, timer )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{16.4} SetTimer ( t ,\,
 timer ,\, Infinity )}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} NCS ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{25.29} \.{\land} GoFromTo
 ( t ,\,\@w{ncs} ,\,\@w{a} )}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{25.29} \.{\land}
 {\UNCHANGED} {\langle} x ,\, now ,\, lbTimer ,\, ubTimer ,\, counter
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} StmtA ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{16.4} \.{\land} x \.{=}
 NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{a} ,\,\@w{b} )}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\land} SetTimer
 ( t ,\, ubTimer ,\, Delta )}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} x ,\, now ,\, lbTimer ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} StmtB ( t ) \.{\defeq}}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land} SetTimer
 ( t ,\, lbTimer ,\, Epsilon )}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} now ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} StmtC ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land} At ( t
 ,\,\@w{c} )}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land} TimedOut
 ( t ,\, lbTimer )}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} {\IF} x
 \.{\neq} t \.{\THEN} GoTo ( t ,\,\@w{a} ) \.{\ELSE} GoTo ( t ,\,\@w{cs} )}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} x ,\, now ,\, lbTimer ,\, ubTimer ,\, counter
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} CS ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{22.13} \.{\land} GoFromTo
 ( t ,\,\@w{cs} ,\,\@w{d} )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{22.13} \.{\land} counter
 \.{'} \.{=} [ counter {\EXCEPT} {\bang} [ t ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{22.13} \.{\land}
 {\UNCHANGED} {\langle} x ,\, now ,\, lbTimer ,\, ubTimer {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} StmtD ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{16.4} \.{\land} x \.{'}
 \.{=} NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{d} ,\,\@w{ncs} )}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} now ,\, lbTimer ,\, ubTimer ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} Tick \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \E\, d \.{\in} Real
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{27.72} \.{\land} d \.{>}
 0}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{27.72} \.{\land} \A\, t
 \.{\in} Thread \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{42.93} ubTimer [ t ]
 \.{\neq} Infinity \.{\implies} ubTimer [ t ] \.{>} d}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{27.72} \.{\land} now
 \.{'} \.{=} now \.{+} d\@s{8.2}}%
\@y{\@s{0}%
 Where is now used in the spec\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{27.72} \.{\land} ubTimer
 \.{'} \.{=} [ t \.{\in} Thread \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{100.10} {\IF} ubTimer [ t
 ] \.{=} Infinity \.{\THEN} Infinity}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{206.53} \.{\ELSE} ubTimer
 [ t ] \.{-} d ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{27.72} \.{\land} lbTimer
...
\@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4} \.{\lor} Tick}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{16.4} \.{\lor} \E\, t
 \.{\in} Thread \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{34.73} \.{\lor} NCS ( t
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{34.73} \.{\lor} StmtA ( t
 ) \.{\lor} StmtB ( t ) \.{\lor} StmtC ( t )}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{34.73} \.{\lor} CS ( t )}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{34.73} \.{\lor} StmtD ( t
 )}%
\@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} SafetySpec \.{\defeq} Init
 \.{\land}\@s{15.56} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} {\THEOREM} SafetySpec
 \.{\implies} {\Box} MutualExclusion}%
\@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Liveness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\land} \A\,
 t\@s{1.02} \.{\in} Thread \.{:} {\WF}_{ vars} ( StmtA ( t ) \.{\lor} StmtC (
 t ) \.{\lor} StmtD ( t ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\land} \A\, r
 \.{\in} Real \.{:} {\Diamond} ( now \.{>} r )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}} FSpec1 \.{\defeq} SafetySpec
 \.{\land} Liveness}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} Progress \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} ( \E\, t \.{\in}
 Thread \.{:} At ( t ,\,\@w{a} ) \.{\lor} At ( t ,\,\@w{b} ) \.{\lor} At ( t
 ,\,\@w{c} ) ) \.{\leadsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{27.51} ( \E\, t \.{\in}
 Thread \.{:} At ( t ,\,\@w{cs} ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} {\THEOREM} FSpec1
 \.{\implies} Progress}%
\@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 06 10:26:36 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Aug} 04
 16:13:33 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
