...
\setboolean{shading}{true}
 ...
 {\MODULE} Fischer1MC}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{Fischer1.tla} modified to be model checked\ensuremath{.
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{-} {\EXTENDS}} \ensuremath{FischerPreface}: replaced by
 \ensuremath{{\EXTENDS}} \ensuremath{FischerPrefaceMC
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{-} Tick}: increase now by \ensuremath{1
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{-} Liveness}: replace ``\ensuremath{\A\, r \.{\in} Real} :
 \ensuremath{{\Diamond}(now \.{>} r)}'' by ``\ensuremath{{\SF}\_vars(Tick)}''
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\EXTENDS} FischerPrefaceMC}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} SetTimer ( t ,\, timer ,\,
 tau ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} timer \.{'} \.{=} [
 timer {\EXCEPT} {\bang} [ t ] \.{=} tau ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} ResetUBTimer ( t ,\, timer )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} SetTimer ( t ,\,
 timer ,\, Infinity )}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} NCS ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{25.29} \.{\land} GoFromTo
 ( t ,\,\@w{ncs} ,\,\@w{a} )}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{25.29} \.{\land}
 {\UNCHANGED} {\langle} x ,\, now ,\, lbTimer ,\, ubTimer ,\, counter
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} StmtA ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} x \.{=}
 NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{a} ,\,\@w{b} )}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land} SetTimer
 ( t ,\, ubTimer ,\, Delta )}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} x ,\, now ,\, lbTimer ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} StmtB ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{16.4} \.{\land} x \.{'}
 \.{=} t}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{b} ,\,\@w{c} )}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{16.4} \.{\land}
 ResetUBTimer ( t ,\, ubTimer )}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} SetTimer
 ( t ,\, lbTimer ,\, Epsilon )}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} now ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} StmtC ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land} At ( t
 ,\,\@w{c} )}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} TimedOut
 ( t ,\, lbTimer )}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\land} {\IF} x
 \.{\neq} t \.{\THEN} GoTo ( t ,\,\@w{a} ) \.{\ELSE} GoTo ( t ,\,\@w{cs} )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} x ,\, now ,\, lbTimer ,\, ubTimer ,\, counter
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} CS ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{22.13} \.{\land} GoFromTo
 ( t ,\,\@w{cs} ,\,\@w{d} )}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{22.13} \.{\land} counter
 \.{'} \.{=} [ counter {\EXCEPT} {\bang} [ t ] \.{=} @ \.{+} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{22.13} \.{\land}
 {\UNCHANGED} {\langle} x ,\, now ,\, lbTimer ,\, ubTimer {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} StmtD ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{16.4} \.{\land} x \.{'}
 \.{=} NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{d} ,\,\@w{ncs} )}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} {\langle} now ,\, lbTimer ,\, ubTimer ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} Tick \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4} \.{\LET} d
 \.{\defeq} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{20.5} \.{\IN} \.{\land}
 \A\, t \.{\in} Thread \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{56.11} ubTimer [ t ]
 \.{\neq} Infinity \.{\implies} ubTimer [ t ] \.{>} d}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{40.89} \.{\land} now
 \.{'} \.{=} now \.{+} d\@s{8.2}}%
\@y{\@s{0}%
 Where is now used in the spec\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{40.89} \.{\land} ubTimer
 \.{'} \.{=} [ t \.{\in} Thread \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{113.28} {\IF} ubTimer [ t
 ] \.{=} Infinity \.{\THEN} Infinity}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{219.71} \.{\ELSE} ubTimer
 [ t ] \.{-} d ]}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{40.89} \.{\land} lbTimer
 \.{'}\@s{2.81} \.{=} [ t \.{\in} Thread \.{\mapsto} Max ( 0 ,\, lbTimer [ t
 ] \.{-} d ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{40.89} \.{\land}
 {\UNCHANGED} {\langle} x ,\, pc ,\, counter {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} Next \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\lor} Tick}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{16.4} \.{\lor} \E\, t
 \.{\in} Thread \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{34.73} \.{\lor} NCS ( t
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{34.73} \.{\lor} StmtA ( t
 ) \.{\lor} StmtB ( t ) \.{\lor} StmtC ( t )}%
\@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{34.73} \.{\lor} CS ( t )}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{34.73} \.{\lor} StmtD ( t
 )}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} SafetySpec \.{\defeq} Init
 \.{\land}\@s{15.56} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} {\THEOREM} SafetySpec
 \.{\implies} {\Box} MutualExclusion}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} Liveness \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{16.4} \.{\land} \A\, t
 \.{\in} Thread \.{:} {\WF}_{ vars} ( StmtA ( t ) \.{\lor} StmtC ( t )
 \.{\lor} StmtD ( t ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{16.4} \.{\land} {\SF}_{
 vars} ( Tick )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}} FSpec1 \.{\defeq} SafetySpec
 \.{\land} Liveness}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} Progress \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} ( \E\, t \.{\in}
 Thread \.{:} At ( t ,\,\@w{a} ) \.{\lor} At ( t ,\,\@w{b} ) \.{\lor} At ( t
 ,\,\@w{c} ) ) \.{\leadsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{27.51} ( \E\, t \.{\in}
 Thread \.{:} At ( t ,\,\@w{cs} ) )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}} {\THEOREM} FSpec1
 \.{\implies} Progress}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 16:13:28 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created Sat \ensuremath{Aug} 07 15:47:31
