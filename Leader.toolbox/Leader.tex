...
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANTS} N ,\, Nbrs ( \_
 ) ,\, MsgDelay ,\, TODelay ,\, Period}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} Node \.{\defeq} 1 \.{\dotdot}
 N}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} ldr ,\,\@s{15.59}}%
\@y{\@s{0}%
 \ensuremath{ldr[n]}: The node that \ensuremath{n} believes to be its leader.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} dist ,\,\@s{12.02}}%
\@y{\@s{0}%
 \ensuremath{dist[n]}: What \ensuremath{n} believes to be its distance to
 \ensuremath{ldr[n]}.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} timer ,\,\@s{4.10}}%
\@y{\@s{0}%
 A countdown timer for node n\mbox{'}s timeout action.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} msgs ,\,\@s{8.2}}%
\@y{\@s{0}%
 the messages in transit
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} now\@s{16.21}}%
\@y{\@s{0}%
 the now timer
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 06 12:00:28 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 06
 11:55:18 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
