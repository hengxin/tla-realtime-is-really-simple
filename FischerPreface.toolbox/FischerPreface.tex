...
\@pvspace{8.0pt}%
 ...
 ,\, pc ,\, ubTimer ,\, lbTimer ,\, now {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} x \.{=}
 NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} pc \.{=}
 [ t\@s{8.11} \.{\in} Thread \.{\mapsto}\@w{ncs} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land} ubTimer
 \.{=} [ t \.{\in} Thread \.{\mapsto} Infinity ]}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land}
 lbTimer\@s{2.81} \.{=} [ t \.{\in} Thread \.{\mapsto} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{16.4} \.{\land} now \.{=}
 0}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} At ( t ,\, loc ) \.{\defeq}
 pc [ t ]\@s{6.50} \.{=} loc}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} GoTo ( t ,\, loc )
 \.{\defeq} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ t ] \.{=} loc ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}} GoFromTo ( t ,\, loc1 ,\,
 loc2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} At ( t
 ,\, loc1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} \.{\land} GoTo ( t
 ,\, loc2 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} TimedOut ( t ,\, timer )
 \.{\defeq} timer [ t ] \.{=} 0}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} MutualExclusion \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{8.2} \A\, t1 ,\, t2
 \.{\in} Thread \.{:} ( t1 \.{\neq} t2 ) \.{\implies} {\lnot} At ( t1
 ,\,\@w{cs} ) \.{\lor} {\lnot} At ( t2 ,\,\@w{cs} )}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 04 16:10:32 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
