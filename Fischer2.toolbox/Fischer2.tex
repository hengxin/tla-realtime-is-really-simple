...
\setboolean{shading}{true}
 ...
 {\MODULE} Fischer2}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} FischerPreface}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANTS} Gamma}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\ASSUME} Epsilon \.{<}
 Gamma}%
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} NCS ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{25.29} \.{\land} GoFromTo
 ( t ,\,\@w{ncs} ,\,\@w{a} )}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{25.29} \.{\land}
 {\UNCHANGED} x}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} StmtA ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{16.4} \.{\land} x \.{=}
 NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{a} ,\,\@w{b} )}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} x}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} StmtB ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} \.{\land} x \.{'}
 \.{=} t}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{b} ,\,\@w{c} )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} StmtC ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{16.4} \.{\land} At ( t
 ,\,\@w{c} )}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land} TimedOut
 ( t ,\, lbTimer )}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land} {\IF} x
 \.{\neq} t \.{\THEN} GoTo ( t ,\,\@w{a} ) \.{\ELSE} GoTo ( t ,\,\@w{cs} )}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} x}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} CS ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{22.13} \.{\land} GoFromTo
 ( t ,\,\@w{cs} ,\,\@w{d} )}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{22.13} \.{\land}
 {\UNCHANGED} x}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} StmtD ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} x \.{'}
 \.{=} NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{d} ,\,\@w{ncs} )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}} TNext ( t ) \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\lor} NCS ( t )}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{16.4} \.{\lor} StmtA ( t
 ) \.{\lor} StmtB ( t ) \.{\lor} StmtC ( t )}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{16.4} \.{\lor} CS ( t )}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{16.4} \.{\lor} StmtD ( t
 )}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} Tick \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{16.4} \E\, d \.{\in} Real
 \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{27.72} \.{\land} d \.{>}
 0}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{27.72} \.{\land} \A\, t
 \.{\in} Thread \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{42.93} ubTimer [ t ]
 \.{\neq} Infinity \.{\implies} ubTimer [ t ] \.{>} d}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{27.72} \.{\land} now
 \.{'} \.{=} now \.{+} d\@s{8.2}}%
\@y{\@s{0}%
 Where is now used in the spec\.{?}
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{27.72} \.{\land} ubTimer
 \.{'} \.{=} [ t \.{\in} Thread \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{100.10} {\IF} ubTimer [ t
 ] \.{=} Infinity \.{\THEN} Infinity}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{206.53} \.{\ELSE} ubTimer
 [ t ] \.{-} d ]}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{27.72} \.{\land} lbTimer
 \.{'}\@s{2.81} \.{=} [ t \.{\in} Thread \.{\mapsto} Max ( 0 ,\, lbTimer [ t
 ] \.{-} d ) ]}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{27.72} \.{\land}
 {\UNCHANGED} {\langle} x ,\, pc ,\, counter {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}} SetTimer ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land} lbTimer
 \.{'}\@s{2.81} \.{=} [ lbTimer {\EXCEPT} {\bang} [ t ] \.{=} {\IF} At ( t
 ,\,\@w{b} ) \.{\THEN} Epsilon}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{246.81} \.{\ELSE} 0 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{16.4} \.{\land} ubTimer
 \.{'} \.{=} [ s \.{\in} Thread \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{88.78} {\IF} s \.{=} t
 \.{\THEN} {\IF} \.{\lor} GoTo ( s ,\,\@w{b} )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{166.92} \.{\lor} GoTo ( s
 ,\,\@w{d} )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{166.92} \.{\lor} GoTo ( s
 ,\,\@w{a} ) \.{\land} x \.{'} \.{=} NotAThread}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{154.76} \.{\THEN} Delta}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{154.76} \.{\ELSE} {\IF}
 GoTo ( s ,\,\@w{c} ) \.{\THEN} Gamma}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{256.45} \.{\ELSE}
 Infinity}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{123.45} \.{\ELSE} {\IF}
 At ( s ,\,\@w{a} ) \.{\THEN} {\IF} x \.{'} \.{=} NotAThread \.{\THEN} Delta}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{331.27} \.{\ELSE}
 Infinity}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{211.97} \.{\ELSE} ubTimer
 [ s ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} now}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}} Next \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} \.{\lor} Tick}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{16.4} \.{\lor} \E\, t
 \.{\in} Thread \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{31.61} \.{\land} TNext (
 t )}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{31.61} \.{\land} SetTimer
 ( t )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}} FSpec2 \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} {\THEOREM} FSpec2
 \.{\implies} {\Box} MutualExclusion}%
\@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 06 11:23:27 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Aug} 06
 10:48:41 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
