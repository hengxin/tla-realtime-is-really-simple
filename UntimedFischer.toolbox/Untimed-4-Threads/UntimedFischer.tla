...
Note that without the time constraints,
this untimed version does not guarantee mutual exclusion;
see the error trace for model "Untimed-5-Thread".
*)
CONSTANTS
...
\* Last modified Wed Aug 04 14:41:52 CST 2021 by hengxin
