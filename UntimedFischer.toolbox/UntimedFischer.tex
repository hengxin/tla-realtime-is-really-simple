...
\setboolean{shading}{true}
 ...
 {\MODULE} UntimedFischer}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The specification of the untimed version of the Fisher\mbox{'}s Mutual
 Exclusion algorithm.
 See Section 2.2 of the paper ``Real Time is Really Simple'' by
 \ensuremath{Leslie} \ensuremath{Lamport}, 2005.
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\CONSTANTS}}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} Thread\@s{4.1}}%
\@y{\@s{0}%
 the set of threads, ranged over by \ensuremath{t \.{\in} Thread
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} NotAThread \.{\defeq}
 {\CHOOSE} t \.{:} t \.{\notin} Thread}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} {\VARIABLES}}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} x ,\,\@s{4.1}}%
\@y{\@s{0}%
 whose \ensuremath{turn \.{\in} Thread \.{\cup} \{NotAThread\}} is it now
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{16.4} pc\@s{6.28}}%
\@y{\@s{0}%
 \ensuremath{pc[t] \.{\in} \{\@w{ncs},\, \@w{a},\, \@w{b},\, \@w{c},\,
 \@w{cs},\, \@w{d}\}}: program counter of thread \ensuremath{t \.{\in} Thread
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} vars \.{\defeq} {\langle} x
 ,\, pc {\rangle}}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 x \.{\in} Thread \.{\cup} \{ NotAThread \}}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 pc \.{\in} [ Thread \.{\rightarrow} \{\@w{ncs} ,\,\@w{a} ,\,\@w{b} ,\,\@w{c}
 ,\,\@w{cs} ,\,\@w{d} \} ]}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} At ( t ,\, loc ) \.{\defeq}
 pc [ t ]\@s{6.50} \.{=} loc}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} GoTo ( t ,\, loc )
 \.{\defeq} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ t ] \.{=} loc ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} GoFromTo ( t ,\, loc1 ,\,
 loc2 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} \.{\land} At ( t
 ,\, loc1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{16.4} \.{\land} GoTo ( t
 ,\, loc2 )}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} Init \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{16.4} \.{\land} x \.{=}
 NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} \.{\land} pc \.{=}
 [ t \.{\in} Thread \.{\mapsto}\@w{ncs} ]}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}} NCS ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{25.29} \.{\land} GoFromTo
 ( t ,\,\@w{ncs} ,\,\@w{a} )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{25.29} \.{\land}
 {\UNCHANGED} x}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} StmtA ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{16.4} \.{\land} x \.{=}
 NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{a} ,\,\@w{b} )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} x}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} StmtB ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{16.4} \.{\land} x \.{'}
 \.{=} t}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{b} ,\,\@w{c} )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} StmtC ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land} At ( t
 ,\,\@w{c} )}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land} {\IF} x
 \.{\neq} t \.{\THEN} GoTo ( t ,\,\@w{a} ) \.{\ELSE} GoTo ( t ,\,\@w{cs} )}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4} \.{\land}
 {\UNCHANGED} x}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} CS ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{22.13} \.{\land} GoFromTo
 ( t ,\,\@w{cs} ,\,\@w{d} )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{22.13} \.{\land}
 {\UNCHANGED} x}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} StmtD ( t ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4} \.{\land} x \.{'}
 \.{=} NotAThread}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{16.4} \.{\land} GoFromTo
 ( t ,\,\@w{d} ,\,\@w{ncs} )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{16.4} \E\, t \.{\in}
 Thread \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{27.72} \.{\lor} NCS ( t
 )}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{27.72} \.{\lor} StmtA ( t
 ) \.{\lor} StmtB ( t ) \.{\lor} StmtC ( t )}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{27.72} \.{\lor} CS ( t )}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{27.72} \.{\lor} StmtD ( t
 )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} ME \.{\defeq} {\lnot} ( \E\,
 t1 ,\, t2 \.{\in} Thread \.{:} t1 \.{\neq} t2 \.{\land} At ( t1 ,\,\@w{cs} )
 \.{\land} At ( t2 ,\,\@w{cs} ) )}%
\@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Aug} 04 14:41:52 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Tue} \ensuremath{Aug} 03
 20:17:02 \ensuremath{CST} 2021 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
